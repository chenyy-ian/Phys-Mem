...
def parse_args():
    ...
    parser.add_argument("--img_path", type=str, default="demo_images/universal/0011.png", help="Path to the image")
    ...
    parser.add_argument("--evict_mode", type=str, default=False, help="Enable StableWorld")
    ...
    def generate_videos(self):
        ...
        with torch.no_grad():
            videos = self.pipeline.inference(
                ...
                mode=mode,
                profile=False,
                evict_mode=self.args.evict_mode,
